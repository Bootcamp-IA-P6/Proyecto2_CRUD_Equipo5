...
# ============================================
# Lookup Models (Admin-manageable - Issue #86)
# ============================================


class VehicleType(models.Model):
    """Vehicle types lookup (SUV, Sedan, Truck)"""
...
class FuelType(models.Model):
    """Fuel types lookup (Gasoline, Diesel, Electric)"""
    name = models.CharField(max_length=100, unique=True)
...
class Transmission(models.Model):
    """Transmission types lookup (Manual, Automatic)"""
    name = models.CharField(max_length=100, unique=True)
...
# ============================================
# Car Models (Validated fields - Issue #86)
# ============================================


class CarModel(models.Model):
    """Car model with validated specifications"""
    ...
    def clean(self):
        """Additional validation for seats and daily price"""
        super().clean()
...
class Car(models.Model):
    """Individual car instance with validated mileage"""
...
class Reservation(models.Model):
    """Reservation with auto-calculated pricing and date validation"""
    ...
    def clean(self):
        """Validate dates and prevent overlapping reservations"""
        super().clean()
        ...
        # Check for overlapping reservations for same car
    ...
    def calculate_details(self):
        """Calculate coverage, rate, and total_price based on user age"""
        today = date.today()
    ...
    def save(self, *args, **kwargs):
        """Auto-calculate pricing details before save"""
